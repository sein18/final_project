		...
		<div id="time">
				<form action="/vacc/vaccInsertRes" method="get" onsubmit="doalert();">
					...
					<table id="table">
			     	...
			     	<br>
			     			<p><b>예방접종</b></p>
			     				<span>종합 7종백신&nbsp;<input name="Vacc" type="radio" required value="${vacc1}1"></span>
			     				<span>코로나 장염&nbsp;&nbsp;<input name="Vacc" type="radio" value="${vacc2}2"></span>
			     				<span>켄넬코프&nbsp;&nbsp;<input name="Vacc" type="radio" value="${vacc3}3"></span>
